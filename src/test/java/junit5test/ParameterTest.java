 ...
 * <p>
 * A parameterized test is one where the @Test method is invoked multiple times with different parameter values each
 * time. A parameterized test must be annotated with @ParameterizedTest, and must specify a source for its arguments.
 * <ul>
 * <li>@ValueSource</li>
 * <li>@EnumSource</li>
 * <li>@MethodSource</li>
...
public class ParameterTest {
    ...
    @DisplayName("@MethodSource with int streamtest")
    @ParameterizedTest
    ...
    @DisplayName("@MethodSource with object streamtest")
    @ParameterizedTest
